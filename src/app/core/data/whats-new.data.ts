...
export const WHATS_NEW_ENTRIES: readonly WhatsNewEntry[] = [
  ...
  },
  {
    ...
    userVisible: true,
    headline: {
      en: 'When the Captain you pinned cannot boost your crew, Auto Team Builder finds one that can',
      el: 'Όταν ο Captain που κλείδωσες δεν μπορεί να δώσει boost στο crew σου, το Auto Team Builder βρίσκει έναν που μπορεί',
    },
    summaryEn:
      'If you pinned a Captain whose ability boosts none of the characters you asked for — say a Captain that boosts only QCK characters, while your team had to be DEX, STR and PSY with both leaders boosting every member — no team could ever keep that Captain. Auto Team Builder could only hand you a team that dropped the boost you asked for, and with Guided auto build on, no team at all. It now notices this before it searches, tries up to eight other Captains from the same characters that can boost your crew, and builds the team you asked for under one of them. It tells you it did: the Final team report gets a Captain row that says who replaced whom, and each character card in the results list explains the change. With Guided auto build on, the message offers a button to use that Captain instead. When no Captain can lead the crew, the message says why and whether others were tried. Builds without a pinned Captain are also much faster: one search we measured went from about three minutes to a few seconds. This version also brings in four new characters from the game\'s data: Chopper & Bonney, Biblo, Ange and Queen the Plague - Impeding Lead Performer.',
    summaryEl:
      'Αν κλείδωνες Captain που το ability του δεν δίνει boost σε κανέναν από τους χαρακτήρες που ζήτησες — ας πούμε Captain που δίνει boost μόνο σε QCK χαρακτήρες, ενώ η ομάδα σου έπρεπε να είναι DEX, STR και PSY και να δίνουν boost και οι δύο leaders σε κάθε μέλος — καμία ομάδα δεν μπορούσε να κρατήσει εκείνον τον Captain. Το Auto Team Builder μπορούσε να σου δώσει μόνο μια ομάδα χωρίς το boost που ζήτησες, και με το Καθοδηγούμενο auto build ενεργό, καμία ομάδα. Τώρα το καταλαβαίνει πριν ψάξει, δοκιμάζει έως οκτώ άλλους Captain από τους ίδιους χαρακτήρες που μπορούν να δώσουν boost στο crew σου, και χτίζει την ομάδα που ζήτησες με έναν από αυτούς. Και σου το λέει: το Τελικό report ομάδας αποκτά γραμμή Captain που λέει ποιος αντικατέστησε ποιον, και κάθε κάρτα χαρακτήρα στη λίστα αποτελεσμάτων εξηγεί την αλλαγή. Με το Καθοδηγούμενο auto build ενεργό, το μήνυμα σου δίνει κουμπί για να βάλεις εκείνον τον Captain. Όταν κανένας Captain δεν μπορεί να οδηγήσει το crew, το μήνυμα λέει γιατί και αν δοκιμάστηκαν άλλοι. Τα builds χωρίς κλειδωμένο Captain είναι επίσης πολύ πιο γρήγορα: μια αναζήτηση που μετρήσαμε έπεσε από περίπου τρία λεπτά σε λίγα δευτερόλεπτα. Η έκδοση φέρνει επίσης τέσσερις νέους χαρακτήρες από τα δεδομένα του παιχνιδιού: Chopper & Bonney, Biblo, Ange και Queen the Plague - Impeding Lead Performer.',
    added: [
      {
        en: 'Four new characters join the roster: **Chopper & Bonney** (6-star DEX Cerebral/Striker), **Biblo** and **Ange** (5-star DEX), and **Queen the Plague - Impeding Lead Performer** (6+ star DEX Driven/Powerhouse). They are already everywhere the app lists characters: search, the **Characters** screen, **Captain Coverage**, both team builders and the ability filters.',
        el: 'Τέσσερις νέοι χαρακτήρες μπαίνουν στη λίστα: **Chopper & Bonney** (6 αστέρων DEX Cerebral/Striker), **Biblo** και **Ange** (5 αστέρων DEX), και **Queen the Plague - Impeding Lead Performer** (6+ αστέρων DEX Driven/Powerhouse). Βρίσκονται ήδη παντού όπου η εφαρμογή δείχνει χαρακτήρες: στην αναζήτηση, στην οθόνη **Characters**, στο **Captain Coverage**, και στους δύο team builders και στα φίλτρα ικανοτήτων.',
      },
      {
        en: 'The **Final team report** on **Auto Team Builder** has a new **Captain** row. When your pinned Captain was replaced it says who replaced whom, and each character card in the **results list** explains the change.',
        el: 'Το **Τελικό report ομάδας** στο **Auto Team Builder** έχει νέα γραμμή **Captain**. Όταν ο Captain που κλείδωσες αντικαταστάθηκε, λέει ποιος αντικατέστησε ποιον, και κάθε κάρτα χαρακτήρα στη **λίστα αποτελεσμάτων** εξηγεί την αλλαγή.',
      },
      {
        en: 'With **Guided auto build** on, the message **Auto Team Builder** shows when no team is built now names a Captain that would work and offers a **Use … as Captain** button.',
        el: 'Με το **Καθοδηγούμενο auto build** ενεργό, το μήνυμα που δείχνει το **Auto Team Builder** όταν δεν χτίζεται ομάδα ονομάζει πλέον έναν Captain που θα ταίριαζε και έχει κουμπί **Βάλε τον … ως Captain**.',
      },
    ],
    improved: [
      {
        en: 'When no Captain from your characters can lead the crew, the message on **Auto Team Builder** now says why your Captain could not, and whether other Captains were tried.',
        el: 'Όταν κανένας Captain από τους χαρακτήρες σου δεν μπορεί να οδηγήσει το crew, το μήνυμα στο **Auto Team Builder** λέει πλέον γιατί δεν μπορούσε ο δικός σου, και αν δοκιμάστηκαν άλλοι Captain.',
      },
      {
        en: '**Auto Team Builder** builds much faster when you have not pinned a Captain: one search we measured went from about three minutes to a few seconds, with the same team.',
        el: 'Το **Auto Team Builder** χτίζει πολύ πιο γρήγορα όταν δεν έχεις κλειδώσει Captain: μια αναζήτηση που μετρήσαμε έπεσε από περίπου τρία λεπτά σε λίγα δευτερόλεπτα, με την ίδια ομάδα.',
      },
    ],
    fixed: [
      {
        en: '**Auto Team Builder** no longer leaves you without the team you asked for when the Captain you pinned cannot boost your crew: it tries up to eight other Captains from the same characters and builds it under one that can.',
        el: 'Το **Auto Team Builder** δεν σε αφήνει πια χωρίς την ομάδα που ζήτησες όταν ο Captain που κλείδωσες δεν μπορεί να δώσει boost στο crew σου: δοκιμάζει έως οκτώ άλλους Captain από τους ίδιους χαρακτήρες και τη χτίζει με έναν που μπορεί.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    improved: [
      ...
      {
        en: 'The saved teams list now has a search box and a sort control. Type a team name, a Captain or a Friend Captain to find one, and order the list by team name, Captain, or when you saved it. Your search and order are remembered while the app stays open, and the list keeps its usual order until you pick one.',
        el: 'Η λίστα των αποθηκευμένων ομάδων έχει πλέον πεδίο αναζήτησης και έλεγχο ταξινόμησης. Γράψε όνομα ομάδας, Captain ή Friend Captain για να τη βρεις, και ταξινόμησε τη λίστα κατά όνομα ομάδας, Captain, ή πότε την αποθήκευσες. Η αναζήτηση και η σειρά σου θυμούνται όσο η εφαρμογή είναι ανοιχτή, και η λίστα κρατά τη συνηθισμένη της σειρά μέχρι να διαλέξεις.',
      },
      {
        en: 'Captain Coverage and the character picker in the Manual Team Builder now remember your filters, not just your team. Leave the screen to look at a character and come back, or reload, and the filter bar is as you left it. Clear all filters still clears them.',
        el: 'Το Captain Coverage και ο επιλογέας χαρακτήρων στο Manual Team Builder θυμούνται πλέον τα φίλτρα σου, όχι μόνο την ομάδα. Φύγε από την οθόνη για να δεις έναν χαρακτήρα και γύρνα πίσω, ή κάνε reload, και η μπάρα φίλτρων είναι όπως την άφησες. Το Clear all filters εξακολουθεί να τα καθαρίζει.',
      },
      {
        en: 'A long search on Auto Team Builder now shows you a provisional team as soon as it finds one, above the results list, instead of only a percentage climbing. It is replaced as better ones are found and disappears when the real result arrives - which is still the same team you would have got before.',
        el: 'Μια μεγάλη αναζήτηση στο Auto Team Builder σου δείχνει πλέον μια προσωρινή ομάδα μόλις βρει μία, πάνω από τη λίστα αποτελεσμάτων, αντί μόνο ένα ποσοστό που ανεβαίνει. Αντικαθίσταται καθώς βρίσκονται καλύτερες και εξαφανίζεται όταν έρθει το πραγματικό αποτέλεσμα - που είναι ακριβώς η ίδια ομάδα που θα έπαιρνες και πριν.',
      },
    ],
    headline: {
