...
function isSourceDataPath(filePath) {
  return (
    ...
    /*
     * 869f63gm1. And again: skulls and score challenges that are not units, and how a unit is
     * obtained (`flags.js`, `shops.js`, `banners.js`).
     */
