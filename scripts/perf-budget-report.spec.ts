...
function routeLoadResult(overrides: Record<string, number | null> = {}) {
  ...
  return {
    ...
    bundle: {
      ...
      payload: {
        cachedBytes: value('prefetchCachedBytes', 8_700_000),
        wireBytes: value('prefetchWireBytes', 4_030_000),
        databaseBytes: value('databaseBytes', 2_280_000),
        abilityCatalogCachedBytes: value('abilityCatalogCachedBytes', 794_000),
        abilityCatalogWireBytes: value('abilityCatalogWireBytes', 139_000),
