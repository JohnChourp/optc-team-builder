...
export const WHATS_NEW_ENTRIES: readonly WhatsNewEntry[] = [
  ...
  },
  {
    ...
    "summaryEn": "This release carries no changes to the app. Nothing was added, fixed or moved, and everything works exactly as it did in the previous version.",
    "summaryEl": "Αυτή η έκδοση δεν φέρνει καμία αλλαγή στην εφαρμογή. Δεν προστέθηκε, δεν διορθώθηκε και δεν μετακινήθηκε τίποτα, και όλα δουλεύουν ακριβώς όπως και στην προηγούμενη έκδοση.",
    "added": [],
    "improved": [],
    "fixed": []
  },
  {
    ...
    "summaryEn": "This version carries no changes to the app. Nothing was added, removed or fixed for players.",
    "summaryEl": "Αυτή η έκδοση δεν φέρνει καμία αλλαγή στην εφαρμογή. Δεν προστέθηκε, δεν αφαιρέθηκε και δεν διορθώθηκε τίποτα για τους παίκτες.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  ...
  },
  {
    ...
    "summaryEn": "This release only changed where the project's own checks run — on the maintainer's machine now, instead of automatically on GitHub every time. The app, its character data and the automatic data-update releases are untouched, so there is nothing new to see or do.",
    "summaryEl": "Αυτό το release άλλαξε μόνο το πού τρέχουν οι εσωτερικοί έλεγχοι του project — τώρα τοπικά στον υπολογιστή, αντί αυτόματα στο GitHub κάθε φορά. Η εφαρμογή, τα δεδομένα των χαρακτήρων και τα αυτόματα releases με νέα δεδομένα μένουν ίδια, οπότε δεν υπάρχει κάτι καινούργιο να δεις.",
    "added": [],
    "improved": [],
    "fixed": []
  },
  {
    ...
    "summaryEn": "This version carried no visible change. Nothing was added, changed or fixed in the app itself — it went out only to keep the release line moving.",
    "summaryEl": "Αυτή η έκδοση δεν έφερε καμία ορατή αλλαγή. Δεν προστέθηκε, δεν άλλαξε και δεν διορθώθηκε τίποτα μέσα στην εφαρμογή — βγήκε μόνο για να συνεχιστεί η σειρά των εκδόσεων.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  },
  {
    ...
    "summaryEn": "No work landed in this release. It only moves the version number forward, so nothing looks or behaves differently.",
    "summaryEl": "Σε αυτή την έκδοση δεν μπήκε καμία δουλειά. Απλώς προχωράει ο αριθμός έκδοσης, οπότε τίποτα δεν αλλάζει σε εμφάνιση ή συμπεριφορά.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  },
  {
    ...
    "summaryEn": "This release only updated the building blocks the app is made of, keeping them current and secure. No screen, filter or team-building behaviour changed. Everything works exactly as it did in the previous version.",
    "summaryEl": "Αυτή η έκδοση ενημέρωσε μόνο τα εργαλεία και τις βιβλιοθήκες πάνω στις οποίες στηρίζεται η εφαρμογή, ώστε να μένουν φρέσκα και ασφαλή. Καμία οθόνη, κανένα φίλτρο και καμία συμπεριφορά στο χτίσιμο ομάδων δεν άλλαξε. Όλα δουλεύουν ακριβώς όπως και στην προηγούμενη έκδοση.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  },
  {
    ...
    "summaryEn": "No player-facing changes in this release. It exists to keep the website and the Android build on the same version number.",
    "summaryEl": "Σε αυτή την έκδοση δεν υπάρχει καμία αλλαγή για τους παίκτες. Βγήκε ώστε η ιστοσελίδα και το Android build να έχουν τον ίδιο αριθμό έκδοσης.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  },
  {
    ...
    "summaryEn": "Your Google account for Drive backup used to quietly disconnect after about an hour, so coming back to the app showed you as signed out even though you never signed out. Your account now stays connected until you disconnect it yourself, and backing out of the Google prompt no longer logs you out either.",
    "summaryEl": "Ο λογαριασμός Google για το backup στο Drive αποσυνδεόταν αθόρυβα μετά από περίπου μία ώρα, οπότε γυρνώντας στην εφαρμογή σε έδειχνε αποσυνδεδεμένο ενώ εσύ δεν είχες κάνει τίποτα. Πλέον ο λογαριασμός μένει συνδεδεμένος μέχρι να τον αποσυνδέσεις εσύ, και το να κλείσεις το παράθυρο της Google δεν σε βγάζει έξω.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Some effects show up twice in the ability picker — once as a Captain requirement, once in their own category; Enemy Damage Reduction is one of 62. Picking one from the Special section wrongly turned it into a Captain-only requirement and lit both tiles, and the results collapsed from 351 matching characters to 11. Now the section you click decides, and the Captain version and the non-Captain version can be picked as two separate filters.",
    "summaryEl": "Κάποια εφέ εμφανίζονται δύο φορές στον επιλογέα ικανοτήτων: μία ως απαίτηση Captain και μία στη δική τους κατηγορία — το Enemy Damage Reduction είναι ένα από τα 62. Αν το διάλεγες από την ενότητα Special, η εφαρμογή το μετέτρεπε λανθασμένα σε απαίτηση μόνο για Captain και άναβε και τα δύο πλακίδια, με αποτέλεσμα η λίστα να πέφτει από 351 χαρακτήρες σε 11. Πλέον μετράει η ενότητα που πάτησες, και η Captain και η μη-Captain εκδοχή διαλέγονται ως δύο ξεχωριστά φίλτρα.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Type and class filters now take more than one value at a time, on every screen that has them. Pick STR and QCK and say whether you want characters that are either one, or characters that are both. Since a character holds at most two types, the app blocks impossible combinations out loud instead of quietly handing you an empty list. Two old filtering bugs surfaced and were fixed along the way.",
    "summaryEl": "Τα φίλτρα type και class δέχονται πλέον περισσότερες από μία τιμές, σε κάθε οθόνη που τα έχει. Διάλεξε STR και QCK και όρισε αν θέλεις χαρακτήρες που είναι είτε το ένα είτε το άλλο, ή χαρακτήρες που είναι και τα δύο. Επειδή ένας χαρακτήρας έχει το πολύ δύο types, η εφαρμογή μπλοκάρει φανερά τους αδύνατους συνδυασμούς αντί να σου δίνει σιωπηλά άδεια λίστα.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Some specials describe their effect as landing \"in the next turn\" instead of \"in the following turn\" — the same thing, worded differently. Those were quietly skipped when you filtered for delayed effects. Doc Q and Blackbeard now show up in that filter where they always belonged.",
    "summaryEl": "Κάποια specials γράφουν ότι το effect τους πέφτει «in the next turn» αντί για «in the following turn» — το ίδιο πράγμα, με άλλα λόγια. Αυτά έμεναν αθόρυβα εκτός όταν φιλτράριζες για καθυστερημένα effects. Ο Doc Q και ο Blackbeard εμφανίζονται πλέον εκεί που ανήκαν εξαρχής.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "The tap-timing filter was blind to anything written in the plural — \"3 PERFECTs in a row\", \"N consecutive PERFECTs\" — which is exactly how most captains word it. Gear Third Luffy, Law, Akainu, Morley and roughly a hundred more were simply missing from it. Matches went from 331 to 436, and nothing wrong crept in: effects that only make PERFECTs easier to hit still stay out.",
    "summaryEl": "Το φίλτρο για tap timing δεν έβλεπε τίποτα γραμμένο στον πληθυντικό — «3 PERFECTs in a row», «N consecutive PERFECTs» — που είναι ακριβώς ο τρόπος που το γράφουν οι περισσότεροι captains. Gear Third Luffy, Law, Akainu, Morley και άλλοι εκατό περίπου απλώς έλειπαν. Τα αποτελέσματα πήγαν από 331 σε 436, χωρίς να μπει τίποτα άσχετο: τα εφέ που απλώς κάνουν τα PERFECT πιο εύκολα μένουν εκτός.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Another pass over the Special filters on Captain Coverage. A handful of characters whose special is worded unusually were being missed, and one was filed under exactly the effect her special says it does not touch. The tap-timing filter was also renamed, because players search for \"PERFECT\" and the old name returned nothing.",
    "summaryEl": "Ακόμα ένα πέρασμα στα φίλτρα Special του Captain Coverage. Λίγοι χαρακτήρες με ασυνήθιστη διατύπωση στο special τους έμεναν εκτός, ενώ μία καταχωρούνταν ακριβώς στο effect που το special της λέει ρητά ότι δεν αγγίζει. Το φίλτρο tap timing μετονομάστηκε κιόλας, γιατί οι παίκτες ψάχνουν «PERFECT» και το παλιό όνομα δεν έβγαζε τίποτα.",
    "added": [],
    "improved": [
      {
  ...
  },
  {
    ...
    "summaryEn": "The buff the game normally calls Color Affinity was only listed as \"Boost Type Effects\", so typing color affinity in the ability filter returned nothing at all — even though 426 characters have it. It is now shown as Boost Type Effects (Color Affinity) and turns up under either name.",
    "summaryEl": "Το buff που το παιχνίδι το λέει συνήθως Color Affinity ήταν καταχωρημένο μόνο ως «Boost Type Effects», οπότε αν έγραφες color affinity στο φίλτρο των abilities δεν έβγαινε τίποτα — παρότι το έχουν 426 χαρακτήρες. Πλέον εμφανίζεται ως Boost Type Effects (Color Affinity) και το βρίσκεις και με τα δύο ονόματα.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "A pass over 23 special-ability filters found that a lot of specials were being described wrongly. Cures that last a few turns were shown as clearing a status permanently, maxed characters were listed with their level 1 turn counts, and one filter was so broken it found almost nobody. All of that is corrected, so what a special filter promises is what the special does.",
    "summaryEl": "Ένα πέρασμα σε 23 φίλτρα special ικανοτήτων έδειξε ότι πολλά special περιγράφονταν λάθος. Cures που κρατούν λίγους γύρους εμφανίζονταν σαν να καθαρίζουν μόνιμα το status, οι maxed χαρακτήρες καταγράφονταν με τους γύρους του level 1, και ένα φίλτρο ήταν τόσο χαλασμένο που δεν έβρισκε σχεδόν κανέναν. Όλα αυτά διορθώθηκαν, ώστε αυτό που υπόσχεται ένα φίλτρο special να είναι αυτό που κάνει το special.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Asking for captains that boost Orb Effects gave back 29 characters, but only 3 of them actually do it. The rest were captains that boost orb drop chances, make orbs beneficial, or work with Orb Amplification — different mechanics that happened to mention orbs. The filter now returns only the real Orb Effects boosters.",
    "summaryEl": "Ζητώντας captains που ενισχύουν τα Orb Effects έπαιρνες 29 χαρακτήρες, ενώ μόνο οι 3 το κάνουν στ' αλήθεια. Οι υπόλοιποι ανέβαζαν την πιθανότητα για orbs, έκαναν τα orbs beneficial ή δούλευαν με Orb Amplification — άλλοι μηχανισμοί που απλώς ανέφεραν orbs. Πλέον το φίλτρο επιστρέφει μόνο τους πραγματικούς.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "The Captain Coverage filter for Captains whose boost depends on PERFECT tap timing was only catching the ones whose text literally said \"PERFECT hits\". Captains that ask for the third PERFECT in a row, or that keep the boost until your first non-PERFECT hit, or that reward each PERFECT you land, were all missing from the list. The filter now returns 193 Captains instead of 38.",
    "summaryEl": "Το φίλτρο του Captain Coverage για Captains που το boost τους εξαρτάται από PERFECT tap timing έπιανε μόνο όσους έγραφαν κατά λέξη «PERFECT hits». Captains που ζητούν το τρίτο συνεχόμενο PERFECT, ή που κρατούν το boost μέχρι το πρώτο χτύπημα που δεν είναι PERFECT, ή που ανταμείβουν κάθε PERFECT, έλειπαν όλοι από τη λίστα. Πλέον το φίλτρο επιστρέφει 193 Captains αντί για 38.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Captains whose ability removes Bind duration \"completely\" were not being tagged as Bind removers, so filtering for that effect never returned them. Four of them — Kizaru, both S-Shark versions and RRG — are now recognised, and enemy Percent Damage Reduction removals written the same way are picked up too.",
    "summaryEl": "Οι Captains που το ability τους αφαιρεί το Bind duration «completely» δεν καταγράφονταν ως Bind removers, οπότε το φίλτρο για αυτό το effect δεν τους έβρισκε ποτέ. Τέσσερις από αυτούς — ο Kizaru, και οι δύο εκδοχές του S-Shark και ο RRG — αναγνωρίζονται πλέον, ενώ πιάνονται και οι αφαιρέσεις Percent Damage Reduction του εχθρού που είναι γραμμένες με τον ίδιο τρόπο.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "A small correction to how Captain Abilities are read. Kaido & Big Mom's captain ability talks about changing an orb's multiplier, not its type, but the app was reading it as an orb change and listing the unit among orb-changing captains. It no longer does; the other 65 orb-changing captains are unaffected. The rest of this release was test maintenance with nothing to see.",
    "summaryEl": "Μια μικρή διόρθωση στο πώς διαβάζονται τα Captain Abilities. Το captain ability των Kaido & Big Mom μιλάει για αλλαγή στο Orb Multiplier, όχι στον τύπο του orb, αλλά η εφαρμογή το διάβαζε ως αλλαγή orb και έβγαζε τη μονάδα ανάμεσα στους captain που αλλάζουν orbs. Πλέον όχι, ενώ οι υπόλοιποι 65 τέτοιοι captain μένουν ως έχουν. Τα υπόλοιπα της έκδοσης ήταν συντήρηση tests, χωρίς κάτι ορατό.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "When you filtered for Captains whose special deals damage, fifteen Captains turned up that do the exact opposite: they reduce the damage your crew takes from BOMB orbs. Eustass Kid, Franky, Vegapunk, S-Bear, S-Shark and the rest are out of that filter now. At the same time, nine genuine damage specials whose multiplier has a decimal point were being skipped, and they appear again.",
    "summaryEl": "Όταν φιλτράριζες Captains με special που κάνει damage, εμφανίζονταν δεκαπέντε Captains που κάνουν ακριβώς το αντίθετο: μειώνουν το damage που τρώει το crew σου από BOMB orbs. Ο Eustass Kid, ο Franky, ο Vegapunk, ο S-Bear, ο S-Shark και οι υπόλοιποι έφυγαν από αυτό το φίλτρο. Παράλληλα, εννιά πραγματικά damage specials με δεκαδικό πολλαπλασιαστή τα προσπερνούσε το φίλτρο, και ξαναεμφανίζονται.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Searching for captains that reduce the damage you take was returning characters that do the exact opposite. Glass cannons whose ability increases damage received, counter captains that deal back the damage taken, and healers that recover a share of the damage taken were all being counted as damage reducers. Now only captains that genuinely reduce incoming damage come back.",
    "summaryEl": "Η αναζήτηση για captains που μειώνουν το damage που τρως έβγαζε χαρακτήρες που κάνουν ακριβώς το αντίθετο. Glass cannons που αυξάνουν το damage received, counter captains που επιστρέφουν το damage, και healers που γιατρεύουν μέρος του damage μετρούσαν όλοι ως μείωση damage. Πλέον επιστρέφουν μόνο όσοι πραγματικά μειώνουν το damage που δέχεσαι.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "The Reduce Special Charge filter was picking up characters whose ability text only mentioned special cooldown in passing, so the list was longer than it should have been. It now matches only characters that genuinely cut special cooldown at the start of the fight, and about twenty wrongly-listed captains dropped out. There is also a new filter for the opposite family - characters that restore or advance special cooldown - and a misspelled filter label is fixed.",
    "summaryEl": "Το φίλτρο Reduce Special Charge έπιανε και χαρακτήρες που απλώς ανέφεραν το special cooldown στο κείμενό τους, οπότε η λίστα ήταν μεγαλύτερη απ' ό,τι έπρεπε. Τώρα δείχνει μόνο χαρακτήρες που πραγματικά κόβουν special cooldown στην αρχή της μάχης, και έφυγαν περίπου είκοσι captains που δεν είχαν καμία δουλειά εκεί. Μπήκε επίσης ένα νέο φίλτρο για την αντίθετη κατηγορία, τους χαρακτήρες που επαναφέρουν ή προωθούν το special cooldown, και διορθώθηκε μια ορθογραφία σε ετικέτα φίλτρου.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "This release carried no changes you can see or use in the app. It exists only to move the version number forward.",
    "summaryEl": "Αυτή η έκδοση δεν έφερε καμία αλλαγή που να τη δεις ή να τη χρησιμοποιήσεις μέσα στην εφαρμογή. Βγήκε μόνο για να προχωρήσει η αρίθμηση των εκδόσεων.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  },
  {
    ...
    "summaryEn": "A small banner now appears in the corner when a newer version of the app is ready. Update asks you to confirm, then installs it and reloads; Later hides the banner and brings it back after a while. On Android the same banner checks for a new release and takes you to its download page.",
    "summaryEl": "Ένα μικρό banner εμφανίζεται πλέον στη γωνία όταν είναι έτοιμη νεότερη έκδοση της εφαρμογής. Το Update σου ζητάει επιβεβαίωση, μετά την εγκαθιστά και κάνει reload· το Later κρύβει το banner και το ξαναφέρνει αργότερα. Στο Android το ίδιο banner ελέγχει αν βγήκε νέα έκδοση και σε πάει στη σελίδα λήψης της.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Almost all of this release is maintenance work you will never see: release checks, speed measurements and safety nets around the automatic data updates. The one thing you will notice is on Saved Teams, where sharing no longer dead-ends if your browser refuses clipboard access.",
    "summaryEl": "Σχεδόν όλη αυτή η έκδοση είναι δουλειά συντήρησης που δεν θα δεις ποτέ: έλεγχοι έκδοσης, μετρήσεις ταχύτητας και δικλείδες γύρω από τις αυτόματες ενημερώσεις δεδομένων. Το μόνο που θα προσέξεις είναι στις Αποθηκευμένες ομάδες, όπου το share δεν κολλάει πια αν ο browser σου δεν επιτρέπει πρόσβαση στο πρόχειρο.",
    "added": [],
    "improved": [],
    "fixed": [
      {
  ...
  },
  {
    ...
    "summaryEn": "No work landed in this release. It only moves the version number forward, so the app behaves exactly as in the previous one.",
    "summaryEl": "Σε αυτή την έκδοση δεν μπήκε καμία δουλειά. Απλώς προχωράει ο αριθμός έκδοσης, οπότε η εφαρμογή συμπεριφέρεται ακριβώς όπως στην προηγούμενη.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  },
  {
    ...
    "summaryEn": "This release carries no changes at all. The version number moved forward on its own, with nothing added, improved or fixed. If you are already up to date, there is nothing new to look for.",
    "summaryEl": "Αυτή η έκδοση δεν φέρνει καμία απολύτως αλλαγή. Ο αριθμός έκδοσης προχώρησε από μόνος του, χωρίς προσθήκες, βελτιώσεις ή διορθώσεις. Αν είσαι ήδη ενημερωμένος, δεν υπάρχει κάτι καινούργιο να ψάξεις.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  },
  {
    ...
    "summaryEn": "Nothing changed for players in this release. It was published only to keep the website and the Android build on the same version number.",
    "summaryEl": "Σε αυτή την έκδοση δεν άλλαξε τίποτα για τους παίκτες. Βγήκε μόνο για να μείνουν η ιστοσελίδα και το Android build στον ίδιο αριθμό έκδοσης.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  },
  {
    ...
    "summaryEn": "Another version with no changes behind it. Same app, new version number, so the web and Android builds stay in step.",
    "summaryEl": "Άλλη μια έκδοση χωρίς καμία αλλαγή από πίσω. Ίδια εφαρμογή, νέος αριθμός έκδοσης, ώστε web και Android να παραμένουν συγχρονισμένα.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  },
  {
    ...
    "summaryEn": "Nothing landed in this release beyond the version number itself. The app behaves exactly as it did in the previous one.",
    "summaryEl": "Σε αυτή την έκδοση δεν μπήκε τίποτα πέρα από τον ίδιο τον αριθμό έκδοσης. Η εφαρμογή συμπεριφέρεται ακριβώς όπως και στην προηγούμενη.",
    "added": [],
    "improved": [],
    "fixed": []
  },
  {
    ...
    "summaryEn": "Auto Team Builder can now put two teams side by side: the one it just built, one you saved earlier, or one you import from a file. It marks slot by slot where they differ and shows the numbers for each, so you can tell whether a new suggestion is really an upgrade before you keep it.",
    "summaryEl": "Το Auto Team Builder μπορεί τώρα να βάλει δύο ομάδες δίπλα δίπλα: αυτή που μόλις έφτιαξε, μία που είχες αποθηκεύσει ή μία που κάνεις εισαγωγή από αρχείο. Σου δείχνει θέση προς θέση πού διαφέρουν και τα νούμερα της καθεμιάς, ώστε να καταλάβεις αν η νέα πρόταση είναι όντως καλύτερη πριν την κρατήσεις.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Every slot in an Auto Team Builder result can now tell you which characters were considered for it and why they were turned down. Instead of guessing why the unit you expected is missing, you get the actual reason next to the slot, in both languages.",
    "summaryEl": "Κάθε θέση στο αποτέλεσμα του Auto Team Builder μπορεί πια να σου πει ποιοι χαρακτήρες εξετάστηκαν γι' αυτήν και γιατί απορρίφθηκαν. Αντί να μαντεύεις γιατί λείπει ο χαρακτήρας που περίμενες, βλέπεις τον πραγματικό λόγο δίπλα στη θέση, και στις δύο γλώσσες.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Saved Teams can now leave your device. Every team has a Share button that copies a link or a short code, and anyone who pastes it gets that exact crew opened in the Manual Team Builder. You can also copy the plain JSON for one team or for a whole selection.",
    "summaryEl": "Οι Αποθηκευμένες ομάδες μπορούν πλέον να φύγουν από τη συσκευή σου. Κάθε ομάδα έχει κουμπί Share που αντιγράφει ένα link ή έναν σύντομο κωδικό, και όποιος τον κάνει επικόλληση βλέπει ακριβώς αυτή την ομάδα να ανοίγει στο Manual Team Builder. Μπορείς επίσης να αντιγράψεις το σκέτο JSON για μία ομάδα ή για όσες έχεις επιλέξει.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "This release only updated the project's own description and links. Nothing changed in the app itself.",
    "summaryEl": "Αυτή η έκδοση ενημέρωσε μόνο την περιγραφή και τα links του project. Στην ίδια την εφαρμογή δεν άλλαξε τίποτα.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  ...
  },
  {
    ...
    "summaryEn": "The Characters page gets a Captain Ability filter: open the picker, choose the effects you care about, and only characters whose own Captain Ability provides them stay in the list. Everything else in this release was library and security updates with nothing to see on screen.",
    "summaryEl": "Η σελίδα Characters αποκτά φίλτρο Captain Ability: ανοίγεις τον picker, διαλέγεις τα effects που σε ενδιαφέρουν και μένουν στη λίστα μόνο οι χαρακτήρες που τα έχουν στη δική τους Captain Ability. Τα υπόλοιπα σε αυτή την έκδοση ήταν ενημερώσεις βιβλιοθηκών και ασφάλειας, χωρίς κάτι ορατό στην οθόνη.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "The Ship picker and the ability requirement panels got a layout pass. Cards and options now line up in a proper grid and reflow instead of squeezing or overlapping, which mostly shows on phones and narrow windows.",
    "summaryEl": "Το ship picker και τα πάνελ με τις απαιτήσεις abilities πήραν μια δουλειά στη διάταξη. Οι κάρτες και οι επιλογές μπαίνουν πλέον σε κανονικό grid και αναδιατάσσονται αντί να στριμώχνονται ή να πέφτουν η μία πάνω στην άλλη, κάτι που φαίνεται κυρίως σε κινητά και στενά παράθυρα.",
    "added": [],
    "improved": [
      {
  ...
  },
  {
    ...
    "summaryEn": "This one was pure tidying up inside the app: the styling of the ability requirement picker, the ship picker and several other screens was reorganised into smaller pieces that are easier to maintain. Nothing you can see or do changed. Everything looks and behaves exactly as it did before.",
    "summaryEl": "Αυτή η έκδοση ήταν καθαρά εσωτερική τακτοποίηση: τα στυλ του ability requirement picker, του ship picker και μερικών ακόμη οθονών ξαναμοιράστηκαν σε μικρότερα κομμάτια που συντηρούνται πιο εύκολα. Τίποτα από όσα βλέπεις ή κάνεις δεν άλλαξε. Όλα δείχνουν και λειτουργούν ακριβώς όπως πριν.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  ...
  },
  {
    ...
    "summaryEn": "This version went out with no changes at all. It is a routine rebuild that keeps the web app and the Android build on the same version number.",
    "summaryEl": "Αυτή η έκδοση βγήκε χωρίς καμία αλλαγή. Είναι μια τυπική επανέκδοση, ώστε το web app και το Android build να μένουν στον ίδιο αριθμό έκδοσης.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  ...
  },
  {
    ...
    "summaryEn": "Only an internal test check around Captain Coverage was corrected. Nothing you see or do in the app changed.",
    "summaryEl": "Διορθώθηκε μόνο ένας εσωτερικός έλεγχος γύρω από το Captain Coverage. Τίποτα από όσα βλέπεις ή κάνεις στην εφαρμογή δεν άλλαξε.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  ...
  },
  {
    ...
    "summaryEn": "This one only tidied up how pages wait for your saved data before they draw. Favorites, Character Boxes, Saved Teams and the rest behave exactly as they did, so there is no visible change.",
    "summaryEl": "Εδώ τακτοποιήθηκε μόνο ο τρόπος που οι σελίδες περιμένουν τα αποθηκευμένα σου δεδομένα πριν εμφανιστούν. Favorites, Character Boxes, Saved Teams και τα υπόλοιπα δουλεύουν ακριβώς όπως πριν, οπότε δεν υπάρχει ορατή αλλαγή.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  },
  {
    ...
    "summaryEn": "A Manual Team Builder page lets you put a crew together slot by slot: search for candidates, watch the cost as you go, pick a ship and see straight away whether your Captain's conditions are met. Automatic builds are stricter too, keeping only teams where the Captain Ability covers the whole crew. For VS and dual-character Captains you now choose which side of the ability to build around, and each character shows which branch it belongs to.",
    "summaryEl": "Η σελίδα Manual Team Builder σού επιτρέπει να στήσεις crew θέση θέση: ψάχνεις υποψήφιους, βλέπεις το cost να ανεβαίνει, διαλέγεις ship και βλέπεις αμέσως αν πληρούνται οι όροι του Captain. Και οι αυτόματες ομάδες έγιναν πιο αυστηρές, κρατώντας μόνο όσες ο Captain Ability καλύπτει ολόκληρο το crew. Για VS και διπλούς Captain διαλέγεις πλέον σε ποιο σκέλος της ability θα στηριχτείς, και κάθε χαρακτήρας δείχνει σε ποιο σκέλος ανήκει.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "The side navigation menu was stripped of its heavy blur and glow effects, so it slides open smoothly even on slower phones. The whole menu now scrolls as one, which means the language flags at the bottom stay reachable on short screens instead of being trapped below an inner scroll area.",
    "summaryEl": "Το πλαϊνό μενού πλοήγησης έχασε τα βαριά εφέ θολώματος και λάμψης, οπότε ανοίγει ομαλά ακόμα και σε πιο αργά κινητά. Πλέον κυλάει όλο μαζί, που σημαίνει ότι οι σημαίες γλώσσας στο κάτω μέρος φτάνονται πάντα σε μικρές οθόνες, αντί να μένουν κλεισμένες μέσα σε ξεχωριστή περιοχή κύλισης.",
    "added": [],
    "improved": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Nothing changed on any screen in this one. It only cleaned up how the app is built and dropped some packages that were no longer used.",
    "summaryEl": "Σε αυτή την έκδοση δεν άλλαξε τίποτα σε καμία οθόνη. Έγινε μόνο τακτοποίηση στον τρόπο που χτίζεται η εφαρμογή και αφαιρέθηκαν πακέτα που δεν χρησιμοποιούνταν πια.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  },
  {
    ...
    "summaryEn": "This one only touched the build setup and a few background libraries. Nothing changed in how the app looks or behaves.",
    "summaryEl": "Αυτή η έκδοση άγγιξε μόνο τη διαδικασία build και μερικές βιβλιοθήκες που τρέχουν από πίσω. Τίποτα δεν άλλαξε στην εμφάνιση ή στη συμπεριφορά της εφαρμογής.",
    "added": [],
    "improved": [],
    "fixed": []
  },
  {
    ...
    "summaryEn": "This one only touched how the app gets built and published: character data is now refreshed before each new version goes out. Nothing changed in the app itself.",
    "summaryEl": "Αυτή η έκδοση άγγιξε μόνο τον τρόπο που χτίζεται και δημοσιεύεται η εφαρμογή: τα δεδομένα των χαρακτήρων ανανεώνονται πλέον πριν βγει κάθε νέα έκδοση. Μέσα στην εφαρμογή δεν άλλαξε τίποτα.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  ...
  },
  {
    ...
    "summaryEn": "Character Boxes can now be narrowed by cost. Set a minimum and a maximum and only the units that fit show up, and the new bulk controls let you add or remove the whole filtered selection at once instead of tapping character after character.",
    "summaryEl": "Τα Character Boxes φιλτράρονται πλέον και με βάση το cost. Βάζεις ελάχιστο και μέγιστο και βλέπεις μόνο όσους χωράνε, ενώ με τις νέες μαζικές ενέργειες προσθέτεις ή αφαιρείς όλη τη φιλτραρισμένη επιλογή με μια κίνηση, αντί για έναν-έναν.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "The side menu is no longer one long list. Its entries are now sorted into Browse, Build, and Saved & Sync, and only one group stays open at a time, so the screen you want is visible without scrolling.",
    "summaryEl": "Το πλαϊνό μενού δεν είναι πια μία ατέλειωτη λίστα. Οι επιλογές του χωρίστηκαν σε Περιήγηση, Χτίσιμο και Αποθήκευση & Sync, και μένει ανοιχτή μία ομάδα κάθε φορά, ώστε να βλέπεις τη σελίδα που θέλεις χωρίς scroll.",
    "added": [],
    "improved": [
      {
  ...
  },
  {
    ...
    "summaryEn": "A housekeeping release. Links, the sitemap and the records search engines read now point at optcteambuilder.com instead of the old address. Nothing inside the app looks or behaves differently.",
    "summaryEl": "Release συντήρησης. Τα links, το sitemap και όσα διαβάζουν οι μηχανές αναζήτησης δείχνουν πλέον στο optcteambuilder.com αντί για την παλιά διεύθυνση. Μέσα στην εφαρμογή δεν αλλάζει τίποτα.",
    "added": [],
    "improved": [],
    "fixed": []
  },
  ...
  },
  {
    ...
    "summaryEn": "The Auto Team Builder can now treat your Captain slots differently from the rest of the crew. You set one cost range for the Captain and Friend Captain and another for the four crew slots, so you can leave room for an expensive Captain without the builder spending your whole budget on subs. Teams you had already saved keep working exactly as before.",
    "summaryEl": "Ο Auto Team Builder μπορεί πλέον να ξεχωρίζει τις θέσεις των Captain από το υπόλοιπο πλήρωμα. Ορίζεις ένα εύρος cost για Captain και Friend Captain και ένα άλλο για τις τέσσερις θέσεις του πληρώματος, ώστε να μένει χώρος για έναν ακριβό Captain χωρίς να φεύγει όλο το budget στα subs. Ό,τι είχες ήδη αποθηκευμένο δουλεύει ακριβώς όπως πριν.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "In the team builder and in your Character Boxes, each character now shows their abilities grouped by where they come from — Captain, Special, sailor, support — with a count for each group. Abilities that match what you are filtering for are highlighted, so you can size a character up without opening their page.",
    "summaryEl": "Στο team builder και στα Boxes χαρακτήρων, κάθε χαρακτήρας δείχνει τώρα τις ικανότητές του ομαδοποιημένες ανά προέλευση — Captain, Special, sailor, support — με το πλήθος της κάθε ομάδας. Όσες ταιριάζουν με το φίλτρο σου τονίζονται, οπότε κρίνεις τον χαρακτήρα χωρίς να ανοίξεις τη σελίδα του.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Character names on the Characters page and inside the team builder are now real links to the character's page, so opening a character is a single tap and the back button behaves the way you expect. The Auto Team Builder also got cleaner buttons and clearer feedback while a team is being put together.",
    "summaryEl": "Τα ονόματα στη σελίδα Characters και μέσα στον team builder είναι πλέον κανονικοί σύνδεσμοι προς τη σελίδα του χαρακτήρα, οπότε ανοίγεις έναν χαρακτήρα με ένα πάτημα και το κουμπί επιστροφής δουλεύει όπως περιμένεις. Ο Auto Team Builder πήρε επίσης πιο καθαρά κουμπιά και σαφέστερη ενημέρωση όσο χτίζεται η ομάδα.",
    "added": [],
    "improved": [
      {
  ...
  },
  {
    ...
    "summaryEn": "You can now ask for more than a special: potential and support abilities join the ability picker, so a search can demand exactly the effects you need. Pasted enemy text is read better too — the app proposes the abilities it recognised and lets you choose which ones to apply, and it keeps the original text with the saved enemy. Auto Team Builder gains an option to accept any Friend Captain, and Settings lets you control how much of your device the build is allowed to use.",
    "summaryEl": "Πλέον δεν ζητάς μόνο specials: στο picker των abilities μπαίνουν και potential και support, ώστε η αναζήτηση να ζητάει ακριβώς τα effects που χρειάζεσαι. Το enemy text που κάνεις paste διαβάζεται καλύτερα — η εφαρμογή σου προτείνει τα abilities που αναγνώρισε και διαλέγεις ποια θα εφαρμοστούν, ενώ κρατάει και το αρχικό κείμενο μαζί με τον αποθηκευμένο εχθρό. Ο Auto Team Builder αποκτά επιλογή να δέχεται οποιονδήποτε Friend Captain, και στα Settings ρυθμίζεις πόσο θα φορτώνει τη συσκευή σου το build.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "You can now load the characters and ships you actually own into the app, either from an OPTCbx export or straight from screenshots, and check the result before anything is saved. The Auto Team Builder also tells you much more while it works: how far along it is and how long the current step has been running. Settings gained a language switcher and a clearer picture of your Google Drive backup.",
  ...
  },
  {
    ...
    "summaryEn": "Super type and Super class characters are now read correctly everywhere in the app, and each character's page shows their Super Special criteria and Support details. Auto Team Builder learned to respect a quest's leader cost restriction, lets you pick the extra drop mode, and can filter by the leader's Super Special criteria. The character page itself was rebuilt so stats, art and text are easier to read.",
    "summaryEl": "Οι Super type και Super class χαρακτήρες αναγνωρίζονται πλέον σωστά σε όλη την εφαρμογή, και η καρτέλα του κάθε χαρακτήρα δείχνει τα criteria του Super Special και τα support στοιχεία του. Ο Auto Team Builder μαθαίνει το cost restriction του leader, σε αφήνει να διαλέξεις extra drop mode και μπορεί να φιλτράρει με βάση τα criteria του leader Super Special. Η ίδια η καρτέλα χαρακτήρα ξαναχτίστηκε ώστε stats, εικόνες και κείμενα να διαβάζονται πιο εύκολα.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "This release only touched the project's own setup notes. Nothing changed in the app, so you will not see any difference on any screen.",
    "summaryEl": "Αυτή η έκδοση άλλαξε μόνο τις εσωτερικές σημειώσεις του project. Τίποτα δεν άλλαξε στην εφαρμογή, οπότε δεν θα δεις καμία διαφορά σε καμία οθόνη.",
    "added": [],
    "improved": [],
    "fixed": [],
    "userVisible": false
  },
  {
    ...
    "summaryEn": "The Auto Team Builder now runs several searches at the same time, shows a progress bar while it works and tells you how long the worst case could take. In Settings you choose how hard it pushes your device, and you back up or restore your favourites and saved teams from the same place. Picking a ship got a search box, and a built team no longer comes back with the same character in two slots.",
    "summaryEl": "Ο Auto Team Builder τρέχει πλέον πολλές αναζητήσεις μαζί, δείχνει μπάρα προόδου όσο δουλεύει και σου λέει πόσο μπορεί να κρατήσει στη χειρότερη περίπτωση. Από τα Settings διαλέγεις πόσο θα πιέσει τη συσκευή σου και από εκεί κάνεις backup ή επαναφορά στα αγαπημένα και στις αποθηκευμένες ομάδες. Η επιλογή ship απέκτησε αναζήτηση, και η ομάδα δεν βγάζει πια τον ίδιο χαρακτήρα σε δύο θέσεις.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "If you have never saved a team, the Saved Teams page used to be a dead end. Now an import button sits right there on the empty page, so you can bring in a backup or a team someone shared with you without hunting for the option somewhere else.",
    "summaryEl": "Μέχρι τώρα, αν δεν είχες καμία αποθηκευμένη ομάδα, η σελίδα Αποθηκευμένες ομάδες ήταν αδιέξοδο. Πλέον το κουμπί εισαγωγής βρίσκεται εκεί ακριβώς, στην άδεια σελίδα, ώστε να φέρεις ένα backup ή μια ομάδα που σου έστειλαν χωρίς να ψάχνεις την επιλογή αλλού.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "On Saved Enemies you can now bring in a whole batch of enemy setups at once: pick a JSON file or just drag it onto the page. Enemies you already have get updated instead of duplicated, broken records are skipped, and a message tells you exactly what went in and what did not.",
    "summaryEl": "Στους Αποθηκευμένους εχθρούς μπορείς πλέον να φέρεις πολλά setup εχθρών μαζί: διαλέγεις ένα αρχείο JSON ή απλώς το σέρνεις πάνω στη σελίδα. Όσοι εχθροί υπάρχουν ήδη ενημερώνονται αντί να διπλογραφτούν, οι χαλασμένες εγγραφές αγνοούνται, και ένα μήνυμα σου λέει ακριβώς τι μπήκε και τι όχι.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "The Auto Team Builder gets a proper ship picker with artwork instead of a plain dropdown list, and you can now tell the builder which characters and ships to keep out of your team entirely. Saved Teams remember the ship each crew used, and you can load a saved team back into the builder as a starting point. The app also shows its version and a credits badge.",
    "summaryEl": "Ο Auto Team Builder αποκτά κανονικό picker για το ship, με εικόνες αντί για απλή λίστα, και μπορείς πλέον να πεις στον builder ποιους χαρακτήρες και ποια ships να μη βάλει καθόλου στην ομάδα. Τα Saved Teams κρατάνε πια και το ship τους, ενώ μπορείς να φορτώσεις ένα αποθηκευμένο team ως αφετηρία. Η εφαρμογή δείχνει επίσης την έκδοσή της και ένα credits badge.",
    "added": [
      {
  ...
  },
  {
    ...
    "summaryEn": "Filling a team slot now opens a proper character picker instead of a plain list. It shows every character's portrait, has a search box and filters, so you can find the unit you want and drop it straight into the slot you were filling.",
    "summaryEl": "Όταν γεμίζεις ένα team slot, ανοίγει πλέον ένα κανονικό picker χαρακτήρων αντί για μια απλή λίστα. Δείχνει το portrait κάθε χαρακτήρα, έχει πεδίο αναζήτησης και φίλτρα, ώστε να βρίσκεις αμέσως τη μονάδα που θες και να τη βάζεις κατευθείαν στο slot που συμπλήρωνες.",
    "added": [
      {
