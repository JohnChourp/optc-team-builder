...
| Triage OPTC DB release detection and release provenance | [Release detector replay](../README.md#release-detector-replay), the latest `release-detector-status` artifact, and the post-release `release-provenance` artifact | `../optc-team-builder-brain/OPTC_DB_AUTO_RELEASE_RUNBOOK.md` and release-trigger/provenance audits |
