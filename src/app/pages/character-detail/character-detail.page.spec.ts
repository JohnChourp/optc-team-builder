...
describe('CharacterDetailPage reader-facing text', () => {
  const source = readFileSync(resolve(process.cwd(), 'src/app/pages/character-detail/character-detail.page.ts'), 'utf8');
  const en = JSON.parse(readFileSync(resolve(process.cwd(), 'public/i18n/character-detail/en.json'), 'utf8'));
  const el = JSON.parse(readFileSync(resolve(process.cwd(), 'public/i18n/character-detail/el.json'), 'utf8'));
