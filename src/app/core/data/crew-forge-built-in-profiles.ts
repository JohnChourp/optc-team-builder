...
const ANDROID_RECRUITMENT_SLOT_SIZE = 136;
const ANDROID_RECRUITMENT_COLUMN_X = [129, 299, 469, 639] as const;
const ANDROID_RECRUITMENT_CAPTAIN_Y = 740;
const ANDROID_RECRUITMENT_CREWMATE_ROW_Y = [1038, 1212] as const;
