...
- the whole prefetch group, as cached, goes over **9,153,000 B** (869f138qh, re-measured by
  869f138qm on 2026-09-17: 8,716,771 B, x1.05). The same number is a row in the performance report,
  and a spec keeps the two equal. Adding a 757,776 B JSON file to the i18n group of a real build
  failed it. The drop from 10,076,000 is one file: the ability catalogue stopped being written
  pretty-printed, and 880,193 B of it were indentation.
